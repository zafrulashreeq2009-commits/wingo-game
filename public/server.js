...
const JWT_SECRET = process.env.JWT_SECRET || 'wingo_secret_key_2024';
const ADMIN_PASS = process.env.ADMIN_PASSWORD || 'admin123';

const db = new Database('wingo.db');
db.pragma('journal_mode = WAL');

db.exec(`CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, player_id TEXT UNIQUE NOT NULL, phone TEXT UNIQUE NOT NULL, password TEXT NOT NULL, balance REAL DEFAULT 0.00, withdraw_count INTEGER DEFAULT 0, withdraw_date TEXT DEFAULT '', created_at TEXT DEFAULT (datetime('now','localtime')))`);
